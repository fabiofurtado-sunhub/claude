...
config() // carrega .env ANTES de qualquer instanciação de serviço
...
// ──────────────────────────────────────────────────────────────────────────────
// Nenhum serviço é instanciado no escopo global do módulo.
// Toda instanciação ocorre dentro de startServer(), garantindo que
// config() já executou e process.env está populado.
// ──────────────────────────────────────────────────────────────────────────────
...
function validateWebhookSecret(req: IncomingMessage): boolean {
  ...
  if (!secret) return true // sem secret — aceita tudo (dev)
...
// ──────────────────────────────────────────────────────────────────────────────
// STARTUP — instancia serviços e sobe o servidor
// ──────────────────────────────────────────────────────────────────────────────

function startServer(): void {
  // Instanciação DENTRO da função — process.env já está populado pelo config()
